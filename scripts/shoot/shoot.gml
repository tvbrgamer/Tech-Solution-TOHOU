function create_bullet(_shoot_speed,_shoot_angle,_obj_shoot)
{
...
function circle_bullet_pattern(_shoot_speed,_obj_shoot)
{
	for(var _shoot_angle = 0; _shoot_angle < 361;_shoot_angle+=10){
		create_bullet( _shoot_speed, _shoot_angle ,_obj_shoot );
	}
}